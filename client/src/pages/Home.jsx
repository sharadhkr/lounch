  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 to-blue-200">
      ...
      <main className="max-w-7xl mx-auto py-4 px-4 sm:px-6">
        ...
        >
          <div className='flex h-12 ml-2 bg-blue-100 rounded-md p-[7px] shadow-[inset_0px_3px_15px_-10px]'>
          ...
          <div className='w-full justify-around flex'>
            {loading ? (
              ...
              categories.map((category) => (
                <div key={category._id} className="snap-start min-w-fit opacity-70">
