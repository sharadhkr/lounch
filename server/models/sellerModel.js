...
const sellerSchema = new mongoose.Schema(
  {
    ...
    paymentId: { type: String, trim: true }, // Legacy field; consider deprecating
    aadharId: {
      type: String,
      trim: true,
    ...
    paymentDetails: {
      ...
      razorpayAccountId: { type: String, trim: true }, // For Razorpay Route integration
    },
    revenue: {
...
// Pre-save hook to hash password and update `updatedAt`
